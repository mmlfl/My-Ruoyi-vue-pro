...
import cn.iocoder.lfl.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import cn.iocoder.lfl.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import cn.iocoder.lfl.module.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    public OAuth2AccessTokenDO removeAccessToken(String accessToken) {
        OAuth2AccessTokenDO oAuth2AccessTokenDO = oauth2AccessTokenMapper.selectByAccessToken(accessToken);
    ...
    /**
     * 加载用户信息，方便 {@link cn.iocoder.lfl.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId 用户编号
     * @param userType 用户类型
     * @return 用户信息
